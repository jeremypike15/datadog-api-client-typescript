...
export class ObjectLogsArchivesApi {
  ...
  public getLogsArchiveOrder(
    param: LogsArchivesApiGetLogsArchiveOrderRequest,
    options?: Configuration
   ...
   * @param param the request object
   */
  public listLogsArchives(
    param: LogsArchivesApiListLogsArchivesRequest,
    options?: Configuration
...
export class ObjectLogsMetricsApi {
  ...
  public listLogsMetrics(
    param: LogsMetricsApiListLogsMetricsRequest,
    options?: Configuration
